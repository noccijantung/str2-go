...
// BufferedWriteSyncer buffers writes in-memory before flushing them to a wrapped WriteSyncer after
...
// FlushLoop flushLoop flushes the buffer at the configured interval until Stop is
// called.
